...
<div class="header high">
    ...
    <h2>
        ...
        Statements: <span class="metric">87.1% <small>(108 / 124)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">87.1% <small>(108 / 124)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
        __mergeJoinNodes: function () {
            ...
            for (var i = 0; i &lt; joinNodes.length; i++) {
                ...
                <span class="missing-if-branch" title="if path not taken" >I</span>if (j1 &amp;&amp; j2 &amp;&amp; (j1.constraint &amp;&amp; j2.constraint &amp;&amp; j1.constraint.equal(j2.constraint))) {
...
&nbsp;
        __createJoinNode: function (rule, pattern, outNode, side) {
            ...
            } else <span class="missing-if-branch" title="if path not taken" >I</span>if (pattern.rightPattern instanceof FromExistsPattern) {
<span class="cstat-no" title="statement not covered" >                joinNode = new ExistsFromNode(pattern.rightPattern, this.workingMemory);</span>
            } else <span class="missing-if-branch" title="if path not taken" >I</span>if (pattern.rightPattern instanceof ExistsPattern) {
<span class="cstat-no" title="statement not covered" >                joinNode = new ExistsNode();</span>
            } else <span class="missing-if-branch" title="if path not taken" >I</span>if (pattern.rightPattern instanceof FromNotPattern) {
<span class="cstat-no" title="statement not covered" >                joinNode = new FromNotNode(pattern.rightPattern, this.workingMemory);</span>
            } else <span class="missing-if-branch" title="if path not taken" >I</span>if (pattern.rightPattern instanceof FromPattern) {
...
&nbsp;
        __addToNetwork: function (rule, pattern, outNode, side) {
            ...
            } else <span class="missing-if-branch" title="else path not taken" >E</span>if (pattern instanceof CompositePattern) {
...
&nbsp;
        __createAlphaNode: function (rule, pattern, outNode, side) {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (!(pattern instanceof FromPattern)) {
&nbsp;
...
&nbsp;
                <span class="missing-if-branch" title="else path not taken" >E</span>if (outNode instanceof BetaNode) {
                    var adapterNode = this.__createAdapterNode(rule, side);
