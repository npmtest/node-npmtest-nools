...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-nools/node_modules/nools/lib/parser/constraint/grammar.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-nools/node_modules/nools/lib/parser/constraint/grammar.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-nools/node_modules/nools/lib/parser/constraint/</a> &#187; grammar.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var Parser = require("jison").Parser, fs = require("fs");
&nbsp;
<span class="cstat-no" title="statement not covered" >var grammar = {</span>
    "lex": {
        "rules": [
            ["\\s+in\\b", "return 'in';"],
...
&nbsp;
<span class="cstat-no" title="statement not covered" >var parser = new Parser(grammar);</span>
<span class="cstat-no" title="statement not covered" >fs.writeFileSync(__dirname + '/parser.js', parser.generate());</span>
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
</div>
