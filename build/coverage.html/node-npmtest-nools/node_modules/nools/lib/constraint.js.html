...
<div class="header medium">
    ...
    <h2>
        ...
        Statements: <span class="metric">75% <small>(54 / 72)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">64.52% <small>(20 / 31)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">63.64% <small>(21 / 33)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">75% <small>(54 / 72)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
        merge: function (that) {
            var ret = this;
            <span class="missing-if-branch" title="else path not taken" >E</span>if (that instanceof ReferenceConstraint) {
                ret = new this._static([this.constraint, that.constraint, "and"], merge({}, this._options, this._options));
                ret._alias = this._alias || <span class="branch-1 cbranch-no" title="branch not covered" >that._alias;</span>
